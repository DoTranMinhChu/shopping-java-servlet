...
VALUES
    ('John Doe', 'johndoe', 'assets/images/avatar1.jpg', 'johndoe@example.com', '1234567890', 'password1', '123 Main St', '2023-05-13T00:00:00+07:00', NULL),
    ('Jane Smith', 'janesmith', 'assets/images/avatar2.jpg', 'janesmith@example.com', '9876543210', 'password2', '456 Elm St', '2023-05-13T00:00:00+07:00', NULL);
GO
-- Generate mock data for the shops table
INSERT INTO shops (name, user_id, address, created_at, deleted_at)
VALUES
    ('Fashion Paradise', 1, '789 Oak St', '2023-05-13T00:00:00+07:00', NULL),
    ('ElectroTech', 2, '123 Pine St', '2023-05-13T00:00:00+07:00', NULL);
GO
...
INSERT INTO products (name, thumbnail_url, description, price, percent_discount, quantity, shop_id, category_id, total_rating, created_at, deleted_at)
VALUES
    ('T-Shirt 1', 'assets/images/thumbnail1.jpg', 'High-quality cotton t-shirt', 19.99, 0.1, 100, 1, 1, 4.5, '2023-05-13T00:00:00+07:00', NULL),
    ('T-Shirt 2', 'assets/images/thumbnail2.jpg', 'High-quality cotton t-shirts', 499.99, 0.05, 50, 2, 2, 4.8, '2023-05-13T00:00:00+07:00', NULL),
	('T-Shirt 3', 'assets/images/thumbnail1.jpg', 'High-quality cotton t-shirt', 19.99, 0.1, 100, 1, 1, 4.5, '2023-05-13T00:00:00+07:00', NULL),
    ('T-Shirt 4', 'assets/images/thumbnail2.jpg', 'High-quality cotton t-shirts', 499.99, 0.05, 50, 2, 2, 4.8, '2023-05-13T00:00:00+07:00', NULL),
	('T-Shirt 5', 'assets/images/thumbnail1.jpg', 'High-quality cotton t-shirt', 19.99, 0.1, 100, 1, 1, 4.5, '2023-05-13T00:00:00+07:00', NULL),
    ('T-Shirt 6', 'assets/images/thumbnail2.jpg', 'High-quality cotton t-shirt', 499.99, 0.05, 50, 2, 2, 4.8, '2023-05-13T00:00:00+07:00', NULL);
GO
...
INSERT INTO orders (user_id, shop_id, status, created_at, deleted_at)
VALUES
    (1, 1, 'pending', '2023-05-13T00:00:00+07:00', NULL),
    (2, 2, 'delivering', '2023-05-13T00:00:00+07:00', NULL);
GO
